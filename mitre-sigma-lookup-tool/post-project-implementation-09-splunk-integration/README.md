...
- For clarity, there are two folders: `setup`, which shows how I configured everything, and `development`, which contains the code and integrations built on top of the setup
